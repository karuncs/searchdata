...
public class HTMLPageExtractor {
	...
	public static void main(String[] args) {
		//System.out.println(getTextFromHTMLPage("http://www.thehealthcareblog.com/the_health_care_blog/2009/07/commentology-home-health-agencies.html"));
		//12:05:18,253 INFO  [STDOUT] http://www.medworm.com/index.php?rid=2674309&cid=u_0_109_m&fid=35671&url=http%3A%2F%2Fwww.anxietyinsights.info%2Fhormone_levels_contribute_to_stress_resilience.htm
			//http://www.medworm.com/index.php?rid=1674829&cid=t__0_87_m&fid=34872&url=http%3A%2F%2Fwww.healthbolt.net%2F2008%2F08%2F01%2Fcorrection-regarding-the-medpedia-coming-soon-to-a-screen-near-you-post%2F
			//12:05:18,495 INFO  [STDOUT] http://www.medworm.com/index.php?rid=2609173&cid=t__0_46_m&fid=38787&url=http%3A%2F%2Fmsf.ca%2Fblogs%2Fphotos%2F2009%2F07%2F14%2Fpakistan-4%2F
			//12:05:18,617 INFO  [STDOUT] http://www.medworm.com/index.php?rid=1921023&cid=t__0_87_m&fid=35052&url=http%3A%2F%2Ffeeds.feedburner.com%2F%7Er%2FWomensBioethicsBlog%2F%7E3%2F436401707%2Foff-label-meds-are-real-worry-not.html
		
//		System.out.println(getTextFromHTMLPage("http://www.medworm.com/index.php?rid=1921023&cid=t__0_87_m&fid=35052&url=http%3A%2F%2Ffeeds.feedburner.com%2F%7Er%2FWomensBioethicsBlog%2F%7E3%2F436401707%2Foff-label-meds-are-real-worry-not.html"));
...
//		Set<String> result = StringUtils.getToken(root, "&url=");
//		for (String string : result) {
//			System.out.println(result);
//		}
//		String resulst = (String)result.toArray()[result.size()-1];
		...
		//System.out.println(getTextFromHTMLPage("http://www.medworm.com/index.php?rid=2609173&cid=t__0_46_m&fid=38787&url=http%3A%2F%2Fmsf.ca%2Fblogs%2Fphotos%2F2009%2F07%2F14%2Fpakistan-4%2F"));
	}
	...
	/**
	 * This method extract data from a given link and saves at sand box 
	 * @param link
	 */
	public static void extractContentAndSave(String link) {		
		...
		//System.out.println(" Files extracted and written "+ new File(IConstant.SANDBOX).list().length);
	}
	...
	/**
     * Gets the content of a Html document.
     * *newlinks.add("http
     * @param docuemnt
     *            internalDocument.
    ...
    /**
     * Clear the script and style tags.
     * 
     * @param content
     * @return String
     */
    public static String clearTags(String content) {
    	/*
         * In this section <script> tag and <style> tag will be removed from
         * the html document.
         */
        ...
        while (scriptIndex != -1 && endScriptIndex != -1) {
            if (scriptIndex < endScriptIndex) {
                String subContent = content.substring(scriptIndex,
                        endScriptIndex);
