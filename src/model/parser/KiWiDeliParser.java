...
public class KiWiDeliParser {
	...
	public static void main(String[] args) {
		...
		//Set<KiWiResource> kiwiAllResources = kiWiDeliParser.getKiWiDeliData("http://delicious.com/tag/programming");
		//Set<KiWiResource> kiwiAllResources = kiWiDeliParser.getKiWiDeliData("http://delicious.com/tag/programming+java+software");
		...
		//		for (KiWiResource kiWiResource : kiwiAllResources) {
//			System.out.println(kiWiResource.getDesc() +"with tags "+ kiWiResource.getTagString());
//		}
				...
				if (nodeList != null && nodeList.size() > 0)
					{
					   ...
					   for (int itr=0; itr<nodeList.size(); itr++) {
					      ...
					      if (kiWiResource!=null && 
								  kiWiResource.getAuthor()!=null && 
								  kiWiResource.getTags()!=null && 
								 !kiWiResource.getTags().isEmpty()
  							      // check either the first condition or whether is the last
							      && ((itr+1 < nodeList.size()) && persit((LinkTag)nodeList.elementAt(itr+1))) || (itr+1==nodeList.size())) {
