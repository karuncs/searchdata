...
public class SimpleExample {
    ...
    public static void main(final String[] args) {
            ...
            String str1 = "fred durao casa";
            String str2 = "casa durao livro joana manicure";
            ...
            AbstractStringMetric euclideanDistance = new EuclideanDistance();

            
            //rejected
            AbstractStringMetric mongeElkan = new MongeElkan();

            //this single line performs the similarity test
            float result = levenshtein.getSimilarity(str1, str2);
            outputResult(result, levenshtein, str1, str2);
            
            
            //this single line performs the similarity test
            float result2 = cosineSimilarity.getSimilarity(str1, str2);
            outputResult(result2, cosineSimilarity, str1, str2);
            
            
            
            //this single line performs the similarity test
            float result3 = euclideanDistance.getSimilarity(str1, str2);
            outputResult(result3, euclideanDistance, str1, str2);
            
            
            //this single line performs the similarity test
            float result4 = mongeElkan.getSimilarity(str1, str2);
            outputResult(result4, mongeElkan, str1, str2);            
