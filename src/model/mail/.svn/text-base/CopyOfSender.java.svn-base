...
public class CopyOfSender {
  ...
  protected String message_recip = "freddurao@gmail.com";
  ...
  protected String message_cc = "freddurao@gmail.com";
  ...
  public void doSend() {
    ...
    try {
      ...
      mesg.setFrom(new InternetAddress("byebye@lts.com"));
...
//      mesg.addRecipient(Message.RecipientType.CC, ccAddress);
  ...
  public static void main(String[] av) {
    CopyOfSender sm = new CopyOfSender();
    sm.doSend();
  }
...
public CopyOfSender(String message_recip, String message_subject, String message_body) {
	super();
